...
public class Jayabaru {
    ...
    public static void main(String                                                                       []args) {
        ...
        System.out.println("=====> SELAMAT DATANG DI TOKO SEPATU SNAKEJAYA <=====");
        ...
        if (jawab == 1) {
            ...
            System.out.println("=== terima kasih telah berbelaja=== ");
            ...
            System.out.println("=== kasir necha ulala === ");
            System.out.println("nama pembeli : " + a);
            if (jumlahbarang == 1) {
                System.out.println("Tanggal pembelian : " + dateFormat.format(cal.getTime()));
                int diskon = 00000;
            ...
            Scanner emde = new Scanner(System.in);
            System.out.println("\nPilih warna yang anda inginkan");
            Jayabaru.warna("");
            System.out.println("Masukkan pilihan anda: ");
            int pilihan = emde.nextInt();

            Scanner snake = new Scanner(System.in);
            System.out.println("\nPilih jenis sepatu");
            Jayabaru.jenis("");
            System.out.println("Masukkan pilihan anda: ");
            int jwb = snake.nextInt();
